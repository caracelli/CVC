...
Conteudo:
  ENTREGA_REDE/
    ...
    ATUALIZACAO/                       -> para demonstrar o auto-update
      CVC_IAM_ANALYTICS/EXECUTAVEIS/CONFIG/config.xml   (versao 1.0.3)
...
VERSAO_INICIAL = "1.0.2"     # 1=sistema . 0=ajustes Processador . 2=ajustes Visualizador
VERSAO_NOVA = "1.0.3"        # bump apenas para demo do auto-update
...
<versao>1.0.3</versao> (a versao da rede vai estar a frente da
versao local de cada cliente).
    ...
    3. No log (visualizador_log.txt, ao lado do exe):
         [auto-update] atualizando 1.0.2 -> 1.0.3
