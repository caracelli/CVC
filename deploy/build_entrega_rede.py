...
Conteudo:
  ENTREGA_REDE/
    ...
    ATUALIZACAO/                       -> para demonstrar o auto-update
      CVC_IAM_ANALYTICS/EXECUTAVEIS/CONFIG/config.xml   (versao 1.0.4)
...
VERSAO_INICIAL = "1.0.3"     # 1=sistema . 0=ajustes Processador . 3=ajustes Visualizador
VERSAO_NOVA = "1.0.4"        # bump apenas para demo do auto-update
...
<versao>1.0.4</versao> (a versao da rede vai estar a frente da
versao local de cada cliente).
    ...
    3. No log (visualizador_log.txt, ao lado do exe):
         [auto-update] atualizando 1.0.3 -> 1.0.4
